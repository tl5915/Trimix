...
<head>
  ...
  <style>
    ...
    .big-gas { font-size: 70px; font-weight: bold; margin-top: 0px; }
    .voltage { font-size: 18px; margin-top: -2px; color: #444; }
    .section-title { font-size: 18px; margin: 20px 0 6px 0; }
...
<body>
  ...
  <!-- OC Gas Caluclation -->
  <h2 class="section-title">OC Gas Caluclation</h2>
  ...
  <!-- CC Gas Caluclation -->
  <h2 class="section-title">CC Gas Caluclation</h2>
  <div class="data-block">
    MOD (ppO2 1.2): <span id="mod_cc">0</span> m<br>
    END (@ 1.2 MOD): <span id="end_cc">0</span> m<br>
    Density (@ 1.2 MOD): <span id="density_cc">0</span> g/L
  </div>

  <!-- Calibration -->
  <h2 class="section-title">Calibration</h2>
  <div class="cal-block">
    Air O2 Cal Voltage: <span id="oxygencalVoltage">0.0</span> mV<br>
    O2 Cal Percentage: <span id="oxygenCalPercentageText">0</span>%<br>
    High O2 Cal Voltage: <span id="pureoxygenVoltage">0.0</span> mV<br>
    He Cal Percentage: <span id="heliumCalPercentage">0</span>%<br>
    He Cal Voltage: <span id="heliumcalVoltage">0.0</span> mV<br>
    He Zero Position: <span id="bestWiperValue">0</span> / 128
  </div>

  <!-- Calibration Buttons -->
  <div style="margin-top: 10px; display: flex; justify-content: center; column-gap: 40px; row-gap: 10px; flex-wrap: wrap;">
    <button onclick="calibrate('airOxygen')">Cal. Air O2</button>
    <button onclick="calibrate('pureOxygen')">Cal. High O2</button>
    <button onclick="calibrate('airHelium')">Cal. Air He</button>
